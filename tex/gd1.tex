...
% Distant halo stars are important kinematic tracers of the mass enclosed in the Galaxy, but can only provide an unbiased measurement if their velocity dispersion is known in all three dimensions.
% So far, velocity anisotropy of the distant halo has only been measured in pencil beams \parencite[e.g.,][]{deason2013}.
% An analysis of halo stars observed through this project will provide a handle on their kinematic homogeneity and move us towards a more global view of the stellar halo.
